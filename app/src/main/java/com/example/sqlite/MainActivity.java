...
public class MainActivity extends AppCompatActivity {
    ...
    public void RegistrarProducto(View view) {
        ...
        if (!fila.moveToFirst()) {
            ...
            Toast.makeText(this, "EL ID INGRESADO YA EXISTE", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    public void EliminarProducto(View view){
        ...
        if (!IDProducto.isEmpty()){
            ...
            if (Eliminar == 1){
                Toast.makeText(this, "SE ELIMINÓ CORRECTAMENTE EL REGISTRO", Toast.LENGTH_SHORT).show();
                ID.setText("");
                Nombre.setText("");
                Categoria.setSelection(0);
                Cantidad.setText("");
    ...
    public void ModificarProducto(View view){
        ...
        if (!IDproducto.isEmpty() && !NombreProducto.isEmpty() && !CategoriaS.equals("Seleccione:") && !cantidad.equals("") && !precio.equals("") && !ubicacion.equals("Seleccione:")){
            ...
            if (Update == 1){
                Toast.makeText(this, "EL CAMBIO SE REALIZO CORRECTAMENTE", Toast.LENGTH_SHORT).show();
            }else{
                Toast.makeText(this, "LA ID NO SE ENCONTRÓ", Toast.LENGTH_SHORT).show();
            }
        } else {
